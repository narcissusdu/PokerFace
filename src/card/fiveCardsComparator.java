...
public class fiveCardsComparator implements Comparator<FiveCards> {
	...
	private int compareHighCard(FiveCards o1, FiveCards o2) {
		...
		i = 4;
		o1CardValue = o1.getACard(i).getCardValue() == 1 ? 14 : o1.getACard(i)
				.getCardValue();
		o2CardValue = o2.getACard(i).getCardValue() == 1 ? 14 : o2.getACard(i)
				.getCardValue();
		...
		while (i > -1) {
			if (o1.getACard(i).getCardValue() == o2.getACard(i).getCardValue()) {
				...
				return o1.getACard(i).getCardValue()
						- o2.getACard(i).getCardValue();
			}
		}
		return 0;
	}
	...
	private int compareOnePair(FiveCards o1, FiveCards o2) {
		...
		} else if (o1.getACard(1).getCardValue() == o1.getACard(2)
				.getCardValue()) {
			// case 2 ABBCD
		...
		} else if (o1.getACard(2).getCardValue() == o1.getACard(3)
				.getCardValue()) {
			// case 3 ABCCD
		...
		} else if (o2.getACard(1).getCardValue() == o2.getACard(2)
				.getCardValue()) {
			// case 2 ABBCD
		...
		} else if (o2.getACard(2).getCardValue() == o2.getACard(3)
				.getCardValue()) {
			// case 3 ABCCD
...
//		System.out.println("compareTwoPairs");
	...
	private int compareThreeOfAKind(FiveCards o1, FiveCards o2) {
		...
		if(o1.getACard(0).getCardValue() == o1CardValue[0]) {
			...
			o1CardValue[2] = o1.getACard(3).getCardValue();
		}else if(o1.getACard(4).getCardValue() == o1CardValue[0]){
			//Case 1
			o1CardValue[1] = o1.getACard(1).getCardValue();	
			o1CardValue[2] = o1.getACard(0).getCardValue();			
			if(o1CardValue[0]==1){
		...
		if(o2.getACard(0).getCardValue() == o2CardValue[0]) {
			...
			o2CardValue[2] = o2.getACard(3).getCardValue();
		}else if(o2.getACard(4).getCardValue() == o2CardValue[0]){
			//Case 1
			o2CardValue[1] = o2.getACard(1).getCardValue();	
			o2CardValue[2] = o2.getACard(0).getCardValue();			
			if(o2CardValue[0]==1){
	...
	private int compareStraight(FiveCards o1, FiveCards o2) {
		...
		if (o1.getACard(0).getCardValue() == 2
				&& o1.getACard(4).getCardValue() == 1) {
			o1CardValue = 1;
		} else {
			o1CardValue = o1.getACard(0).getCardValue();
		}

		if (o2.getACard(0).getCardValue() == 2
				&& o2.getACard(4).getCardValue() == 1) {
			o2CardValue = 1;
		} else {
...
//			return o1.getACard(2).getCardValue()
//					- o2.getACard(2).getCardValue();			
//		}else{
//			if(o1.getACard(0).getCardValue() == o1.getACard(2)){
//				
//			}
//		}
//		
//
//		if (o1.getACard(2).getCardValue() == o2.getACard(2).getCardValue()) {
//			o1CardValue = (o1.getACard(0).getCardValue() == o1.getACard(2)
//					.getCardValue() ? o1.getACard(4).getCardValue() : o1
//					.getACard(0).getCardValue());
//			o2CardValue = (o2.getACard(0).getCardValue() == o2.getACard(2)
//					.getCardValue() ? o2.getACard(4).getCardValue() : o2
//					.getACard(0).getCardValue());
//			return o1CardValue - o2CardValue;
//
//		} else {
